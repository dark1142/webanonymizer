...
if (isset($attrs[$attr]))
{
    ...
    {
$_url_form      = '<div style="width:100%; margin:0; text-align:center; color:#676767; background:#ccc url(bg.png); font-size:12px; font-family:helvetica,tahoma,arial,verdana; padding:4px;">'
. '<form method="post" action="' . $_script_url . '">'
. ' <label for="____' . $_config['url_var_name'] . '"><img style="padding-left:2pt;margin-right:8px;margin-top:8px" src="pro.png"></label> <input id="____' . $_config['url_var_name'] . '" type="text" size="80" name="' . $_config['url_var_name'] . '" value="' . $_url . '" />'
. ' <input type="submit" name="go" value="Ok" />'
. ' <input type="button" name="go" value="Home" onclick=document.location="index.php" />'
. '<br /><br />';
