...
if (!$GLOBALS['_frozen_flags'][$flag_name])
  {
echo '<div class="option"><label><input style="margin-left:5pt;" type="checkbox"  name="' . $GLOBALS['_config']['flags_var_name'] . '[' . $flag_name . ']"' . ($flag_value ? ' checked="checked"' : '') . ' />' . $GLOBALS['_labels'][$flag_name][1] . '</label></li>' . "\n";
  }
      }
?>
</ul></table></label></li>
